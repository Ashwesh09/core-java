...
public class BuilderDemo {
    public static void main(String[] args) {
        ...
        HouseBuilderFactory hbf = new HouseBuilderFactory();
        HouseBuilder h = hbf.getBuilderInstance("IglooHouseBuilder");
        CivilEngineer ce = new CivilEngineer(h);
        ce.constructHouse();
        House newh = ce.getHouse();
        System.out.println("Finished house::\n" + newh);
    }
}